      ...
      <section style={{ backgroundColor: "#0F1F3D", padding: "80px 24px 72px", textAlign: "center" }}>
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <span style={{ color: "#1D9E75" }}>maintenant</span>
          </h1>
          <p style={{ fontSize: "18px", color: "#7A95BB", maxWidth: "600px", margin: "0 auto 32px", lineHeight: 1.6 }}>
            En 2 minutes, obtenez votre pension estimée, votre âge de départ et un plan d&apos;action personnalisé.
          </p>
          <Link
            href="/diagnostic/intro"
            style={{
          ...
          <p style={{ marginTop: "14px", fontSize: "13px", color: "#7A95BB" }}>
            ⭐⭐⭐⭐⭐ · Déjà utilisé par +500 personnes · Sans carte bancaire · Résultat immédiat
          </p>
        </div>
      </section>
